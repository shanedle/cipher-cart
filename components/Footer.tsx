...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Shopping decoded, privacy assured.
            </p>
            <SocialMedia
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Join our newsletter for fresh drops and exclusive deals.
            </p>
      ...
      <div className="py-6 border-t text-center text-sm text-gray-600 w-full">
        <p>&copy; {year} CipherCart</p>
      </div>
    </footer>
  );
};
